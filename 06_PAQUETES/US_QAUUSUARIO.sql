prompt
prompt PACKAGE: US_QAUSUARIO
prompt
CREATE OR REPLACE PACKAGE HR.US_QAUSUARIO IS
    --
    -- ===========================================================
    -- US_QAUSUARIO
    -- -----------------------------------------------------------
...
CREATE OR REPLACE PACKAGE BODY HR.US_QAUSUARIO IS
    ...
    BEGIN
		...
		US_QAUSUARIO.OBTENERIDTEMPRESA
		(
            p_tempresa_nombre,
            v_id_nombre_tipo_empresa,
            v_cod_rta_tipo
        );
		US_QAUSUARIO.OBTENERIDEMPRESA
		(
            p_nombre_empresa,
            v_id_nombre_empresa,
            v_cod_rta
